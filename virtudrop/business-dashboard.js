...
window.printDeliveryLabel = function(orderId) {
  ...
  const popup = window.open('', '_blank', 'width=820,height=800');
  ...
  popup.document.write(`<!doctype html><html><head><title>Label ${escapeHtml(order.order_number)}</title><style>
    ...
    *{box-sizing:border-box}
    ...
    .label{width:7.2in;max-width:100%;min-height:6.6in;border:2px solid #000;border-radius:18px;padding:0;overflow:hidden;display:flex;flex-direction:column;gap:0;break-inside:avoid;page-break-inside:avoid}
    .brand{text-align:center;padding:18px 22px 15px}
    ...
    .big{font-size:18px;font-weight:900;line-height:1.05;margin-top:12px;white-space:nowrap;letter-spacing:-.02em}
    .date{font-size:17px;margin-top:14px}
    .main{min-height:2.55in}
    .icon{width:44px;height:44px;border:2px solid #000;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 12px}.icon svg{width:25px;height:25px;display:block;fill:none;stroke:#000;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
    .center{text-align:center}
    .name{font-size:18px;font-weight:900;margin:8px 0 10px}
    .addr{font-size:13px;line-height:1.35;margin-top:5px}
    .phone{display:grid;grid-template-columns:44px 1fr;gap:12px;align-items:center;margin-top:22px}
    .phone .icon{margin:0}
    ...
    .foot{display:grid;grid-template-columns:1fr auto 1.25fr;gap:16px;align-items:center;padding:12px 22px 14px}
    ...
    .social svg{width:25px;height:25px;display:block;fill:none;stroke:#000;stroke-width:2}
    ...
    <div class="split main">
      <div class="cell center">
        <div class="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="4"></circle><path d="M4.5 21a7.5 7.5 0 0 1 15 0"></path></svg></div><div class="k">Ship To:</div>
      ...
      <div class="cell center">
        <div class="icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m4 7 8-4 8 4-8 4-8-4Z"></path><path d="M4 7v10l8 4 8-4V7M12 11v10"></path></svg></div><div class="k">Item / Contents:</div>
    ...
    <div class="rule"></div>
    <div class="foot"><div class="thanks">Thank you!</div><div class="divider"></div><div class="social"><svg viewBox="0 0 24 24" aria-label="Instagram"><rect x="3" y="3" width="18" height="18" rx="5"></rect><circle cx="12" cy="12" r="4"></circle><circle cx="17.5" cy="6.5" r="1" fill="#000" stroke="none"></circle></svg><svg viewBox="0 0 24 24" aria-label="Facebook"><path d="M14 21v-8h3l.5-4H14V7c0-1.2.6-2 2.2-2H18V1.5c-.7-.1-1.7-.2-3-.2-3 0-5 1.8-5 5.2V9H7v4h3v8"></path></svg><span>@VirtuForms</span></div></div>
  </div></body></html>`);
